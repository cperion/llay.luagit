...
print("11. Creating element with padding table...")
llay.Element({
    layout = {
    ...
    print("12. Creating element with padding as 4-number table...")
    llay.Element({
        id = "sidebar",
        layout = {
            sizing = { width = 240, height = "GROW" },
            layoutDirection = llay.LayoutDirection.TOP_TO_BOTTOM,
            padding = { 20, 20, 30, 30 }, -- This is a table with 4 numbers
            childGap = 20,
        },
        backgroundColor = { 26, 27, 35, 255 },
    })
end)
print("13. Element with padding table created")
