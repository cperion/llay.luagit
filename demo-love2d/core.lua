...
local function Llay__CalculateFinalLayout()
...
local function Llay__GenerateIdForAnonymousElement(openLayoutElement)
...
function M.open_element()
	...
	if context.openLayoutElementStack.length > 1 then
		Llay__GenerateIdForAnonymousElement(elem)
	end
...
function M.get_scroll_offset()
	...
	if openElement.id == 0 then
		Llay__GenerateIdForAnonymousElement(openElement)
	end
